...
//==========================================================
template <typename Dtype>
class TreepoolMaxAveLayer : public Layer<Dtype> {
 public:
  explicit TreepoolMaxAveLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "TreepoolMaxAve"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
...
//==========================================================
// Tree-based kernel pooling (1-layer tree)
//==========================================================
template <typename Dtype>
class TreepoolKernel1LLayer : public Layer<Dtype> {
 public:
  explicit TreepoolKernel1LLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "TreepoolKernel1L"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
 ...
 protected:
  ...
  Blob<Dtype> split_buffer1_;
  Blob<Dtype> split_buffer2_;
  Blob<Dtype> resp_buffer1_;
  Blob<Dtype> resp_buffer2_;
  Blob<Dtype> mat_buffer_;  
  Blob<Dtype> col_buffer_;
  Blob<Dtype> bottom_diff_buffer_;
  int COUNT2_;
...
//==========================================================
// Tree-based kernel pooling (2-layer tree)
//==========================================================
template <typename Dtype>
class TreepoolKernel2LLayer : public Layer<Dtype> {
 public:
  explicit TreepoolKernel2LLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "TreepoolKernel2L"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
 ...
 protected:
  ...
  Blob<Dtype> split_buffer1_;
  Blob<Dtype> split_buffer2_;
  Blob<Dtype> split_buffer3_;
  Blob<Dtype> split_buffer1c_;
  Blob<Dtype> split_buffer2c_;
  Blob<Dtype> split_buffer3c_;  
  Blob<Dtype> resp_buffer1_;
  Blob<Dtype> resp_buffer2_;
  Blob<Dtype> resp_buffer3_;
  Blob<Dtype> resp_buffer4_;  
  Blob<Dtype> mat_buffer1_;  
  Blob<Dtype> mat_buffer2_;  
  Blob<Dtype> col_buffer_;
  Blob<Dtype> bottom_diff_buffer_;
  int COUNT2_;
  //Blob<float> rand_idx_;
